...
class GeoJsonService
{
    ...
    {
        $latestStatus = $site->latestDailyStatus;
        return [
            'type' => 'Feature',
            'geometry' => [
                'type' => 'Point',
            ...
            'properties' => [
                ...
                'region' => $site->region,
                'status' => $site->status,
                'daily_status' => $latestStatus?->status ?? 'NO_DATA',
                'bandwidth' => $latestStatus?->bandwidth_utilization_mbps,
                'users' => $latestStatus?->total_unique_users,
