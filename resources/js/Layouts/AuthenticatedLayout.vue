...
import {
    ...
    IconChecklist, IconUpload, IconReportAnalytics,
    IconMenu2, IconX, IconLogout, IconUser,
    ...
    <div class="flex min-h-screen bg-slate-50">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:w-sidebar bg-gradient-to-b from-blue-800 to-blue-900 text-white z-30">
            ...
            <div class="px-4 py-5 border-b border-blue-700/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-bold text-white text-sm leading-tight">DICT-MRIS</div>
                        <div class="text-[11px] text-blue-300 leading-tight">Project Tracking</div>
                    </div>
                </div>
            </div>
        ...
        <div v-if="sidebarOpen" class="fixed inset-0 z-[500] lg:hidden">
            ...
            <div class="fixed inset-y-0 left-0 w-sidebar bg-gradient-to-b from-blue-800 to-blue-900 text-white flex flex-col">
                ...
                <div class="border-t border-blue-700/50 p-4">
                    ...
                    <div class="flex gap-2">
                        <Link :href="route('profile.edit')" @click="sidebarOpen = false" class="flex-1 flex items-center justify-center gap-1.5 text-xs text-blue-200 hover:text-white py-1.5 rounded hover:bg-blue-700/30 transition">
                            <IconUser class="w-3.5 h-3.5" /> Profile
                        </Link>
                        <Link :href="route('logout')" method="post" as="button" class="flex-1 flex items-center justify-center gap-1.5 text-xs text-blue-200 hover:text-white py-1.5 rounded hover:bg-blue-700/30 transition">
                            <IconLogout class="w-3.5 h-3.5" /> Log Out
        ...
        <div class="flex-1 lg:ml-sidebar">
            ...
            <header class="sticky top-0 z-20 bg-white/80 backdrop-blur border-b border-slate-200 h-16 flex items-center px-4 sm:px-6">
                <button @click="sidebarOpen = true" class="lg:hidden mr-3 text-slate-500 hover:text-slate-700">
